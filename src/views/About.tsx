        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <Reveal>
            <p className="text-center xl:text-start text-base sm:text-lg text-textSecondary">
              I'm a sophomore at IIT_BHU and a fullstack developer who loves to create beautiful and dynamic full stack websites and applications. I'm a backend developement enthusiast that currently exploring deep backend/devops 
            </p>
          </Reveal>
